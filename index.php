...
if(isset($_POST['login'])){
	...
	else{echo "<script>alert('Incorrect username and password combination. Please try again')</script>";}
}
		   ...
		   <div class="col-sm-8 header-left">
	            ...
	            <div class="col-sm-4 header_right">
					 ...
					 echo " <span>Login</span>";
						  ...
						  echo "<a href='logout.php'><span>Logout</span></a><span style='color:#ff8a22;font-weight:bold'> [  $userId ]</span> <a href='manager.php'><span> Manage </span></a>";}
         ...
         <div class="col-md-8 wow fadeInRight" data-wow-delay="0.4s">
          <div class="educate_grid">
            <div class="col-md-6 room-grid">
   	    	  <div class="living_box"><a href="rooms.php">
				...
				<h3><a href="#">Beautiful hall</a></h3>
				<p> One of the latest conference hall in town</p>
		    ...
		    <div class="col-md-6 room-grid">
				...
				<p>Our single rooms available for booking </p>
				<p class="educate"><img src="images/star1.png" alt=""/></p>			
				<div class="clearfix"></div>
				</div>
			  </div>
		   ...
		   <div class="educate_grid1">
            <div class="col-md-6 room-grid">
				...
				<span class="sale-box">
				  <span class="sale-label">Front View</span>
			    </span>
				</a>
				<div class="living_desc desc1">
				<h3><a href="#">Beautiful Entrance</a></h3>
				<p>So amazing front view of the resort </p>
				<p class="educate"><img src="images/star1.png" alt=""/></p>				
				<div class="clearfix"></div>
				</div>
			  </div>
		    ...
		    <div class="col-md-6 room-grid">
				...
				<span class="sale-box">
				  <span class="sale-label">REST ROOM</span>
			    </span>
				</a>
				<div class="living_desc desc1">
				<h3><a href="#">Amazing Rest Roomm </a></h3>
				<p>So enticing. you can't ignore this!!</p>
				<p class="educate"><img src="images/star1.png" alt=""/></p>		
				<div class="clearfix"></div>
				</div>
			  </div>
