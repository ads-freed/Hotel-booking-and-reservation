...
<div class="header">
   ...
   <div class="living_middle">
		...
		<ul class="nav nav-tabs"><li  ><a data-toggle="tab" href="manager.php">Checkout</a></li>
						...
						<li class="active" ><a data-toggle="tab" href="allrooms.php">All Rooms</a></li>
...
$delid = $_POST['id'];
$del = "DELETE from rooms where Id='$delid' ";

$del_query = mysqli_query($conn, $del);
if($del_query==TRUE){echo "<script>alert('You have successfully removed a room')</script>" ;}
else{"<script>alert('Error while trying to remove room. try again" ;}
}

$sn =0;
$sqli = "SELECT * From rooms order by Id Asc";
...
while($fech = mysqli_fetch_array($query)){
	...
	echo "<tr>";
		...
		<input type='submit' class='btn btn-sm btn-danger' value='Delete' name='delete' /></td></form>";
		echo "</tr>";
}
	?>
