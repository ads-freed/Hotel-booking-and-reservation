...
$sqli = "SELECT * FROM rooms where Status='Available' order by Id Asc";
...
while($fech = mysqli_fetch_array($query)){
	...
	echo "<tr>";
		...
		echo "<td>$price</td>";
		 echo "<td>$status</td>";
		echo "<td><a href='confirm_booking.php?id=$room'><input type='button' name='proceed' value='Proceed to Rent' class='btn btn-warning' />";
