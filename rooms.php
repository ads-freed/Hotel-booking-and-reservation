...
<div class="header">
   ...
   <div class="living_middle">
   	  ...
   	  <div class="container">
   	  		<h2 class="title block-title">Our Luxury Rooms</h2>
...
$sqli = "SELECT * From rooms order by Id Asc Limit 3";
...
while($fech = mysqli_fetch_array($query)){
	...
	$id = $fech["Id"];
	$img = $fech['Photo'];
	$desc = $fech['Description'];
	echo "<div class='col-md-4 wow fadeInLeft' data-wow-delay='0.4s'>
   	    	<div class='living_box'><a href='confirm_booking.php?id=$room'>
				...
				<h3><a href='confirm_booking.php?id=$room'>Single Room</a></h3>
				<p>$desc </p>
				<a href='confirm_booking.php?id=$room' class='btn3'>Rent</a>
				<p class='price'>N $price</p>
				</div>
			    <table border='1' class='propertyDetails'>
                <tbody><tr>
                   <td><img src='images/area.png' alt='' style='margin-right:7px;'>2,412m</td>
                   <td><img src='images/bed.png' alt='' style='margin-right:7px;'>1 Beds</td>
                   <td><img src='images/drop.png' alt='' style='margin-right:7px;'>1 Bath</td>
                    </tr>
                </tbody></table>
			</div>
		 </div>";
...
$sqli = "SELECT * From rooms order by Id Desc Limit 3";
$query = mysqli_query($conn, $sqli);
while($fech = mysqli_fetch_array($query)){
